...
public class MenuUI : MonoBehaviour
{
    ...
    /// <summary>Called from RushMenu when MainMenu loads. Delays the popup so ControllerManager can initialize and avoid "couldn't find specific menu" / "Failed to highlight" errors.</summary>
    public IEnumerator ShowWelcomePopupDelayed()
    {
        yield return new WaitForSeconds(1.5f);
        Utils.showPopup("\nWelcome to RushMenu press the key \"suppr\" to open the Menu !\n\nYou are responsible for your actions");
    }
    ...
    private void Start()
    {
        ...
        //    new ToggleInfo(" ConsoleUI", () => RushMenu.consoleUI.isVisible, x => RushMenu.consoleUI.isVisible = x),
        //}, new List<SubmenuInfo>()));
        ...
        groups.Add(new GroupInfo("Passive", false, [
            ...
            new ToggleInfo(" Panic (Disable RushMenu)", () => false, x => Utils.Panic())
        ], []));
    ...
    private void Update(){
        ...
        if (Input.GetKeyDown(Utils.stringToKeycode(RushMenu.menuKeybind.Value)))
        {
    ...
    public void OnGUI()
    {
        ...
        else
        {
            ...
            string configHtmlColor = RushMenu.menuHtmlColor.Value;
        ...
        windowRect = GUI.Window(0, windowRect, (GUI.WindowFunction)WindowFunction, "RushMenu v" + RushMenu.malumVersion);
    }
