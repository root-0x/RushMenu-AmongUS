...
public partial class RushMenu : BasePlugin
{
    ...
    public override void Load()
    {
        ...
        menuKeybind = Config.Bind("RushMenu.GUI",
                                "Keybind",
                                "Delete",
        ...
        menuHtmlColor = Config.Bind("RushMenu.GUI",
                                "Color",
                                "",
                                "A custom color for your RushMenu GUI. Supports html color codes");

        guestMode = Config.Bind("RushMenu.GuestMode",
                                "GuestMode",
                                false,
        ...
        guestFriendCode = Config.Bind("RushMenu.GuestMode",
                                "FriendName",
                                "",
        ...
        spoofLevel = Config.Bind("RushMenu.Spoofing",
                                "Level",
                                "",
        ...
        spoofPlatform = Config.Bind("RushMenu.Spoofing",
                                "Platform",
                                "",
        ...
        spoofDeviceId = Config.Bind("RushMenu.Privacy",
                                "HideDeviceId",
                                true,
        ...
        noTelemetry = Config.Bind("RushMenu.Privacy",
                                "NoTelemetry",
                                true,
        ...
        SceneManager.add_sceneLoaded((Action<Scene, LoadSceneMode>) ((scene, _) =>
        {
            if (scene.name == "MainMenu")
            {
                ...
                // Welcome message + disclaimer (delayed so main menu UI and ControllerManager finish initializing first)
                if (menuUI != null)
                    menuUI.StartCoroutine(nameof(MenuUI.ShowWelcomePopupDelayed));
            }
        }));
    }
}
